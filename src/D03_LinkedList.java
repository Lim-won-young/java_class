...
public class D03_LinkedList {
	...
	//	- LinkedList는 연결된 노브만 바꾸면 되기 때문에 훨씬 빠르다
	//	- ArrayList는 데이터 보관, 읽기에 유리하고
	//	- LinkedList는 데이터 생성에 및 삭제 유리하다
	...
	public static void main(String[] args) {
		...
		System.out.println("ArrauList Insertion Test 시작");
		for (int i = 0; i < 2000; i++) {
			arr_list.addAll(10,toAdd);
		}
		long end = System.currentTimeMillis();
		System.out.println("ArrauList End : " + (end - start) + "밀리초");
		...
		System.out.println("Test End : " + (end - start) + "밀리초");
