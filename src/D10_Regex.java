...
public class D10_Regex {
	...
	public static void main(String[] args) {
		...
		//	2. Ex{n,m}	: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚºÎÅÍ ÃÖ´ë m±ÛÀÚ ÀÏÄ¡ÇØ¾ß ÇÑ´Ù
		//	3. Ex{n,}	: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚ ÀÌ»ó ÀÏÄ¡ÇØ¾ßÇÑ´Ù
		// 	4. Ex? 		: ÇÑ¹ø È¤Àº ¾ø¾î¾ß ÇÑ´Ù
		//	5. Ex+		: ÃÖ¼Ò ÇÑ¹ø ÀÌ»ó Á¸Àç ÇØ¾ßÇÑ´Ù
		//	6. Ex*		: 0¹ø È¤Àº ¿©·¯¹ø
		System.out.println(Pattern.matches("....[\\d]{4,}", "abfd12341234"));
		System.out.println("À¯È¿ÇÑ ¾ÆÀÌµğ : " + Pattern.matches("[\\w°¡-ÆR]{2,12}", "IlIllll1l1l1"));
		...
		//	- Àü´ŞÇÑ ¹®ÀÚ¿­ÀÌ Á¤±ÔÇ¥Çö½Ä°ú ÀÏÄ¡ÇÏ¸é true ¹İÈ¯
		...
		//	- ¹®ÀÚ¿­À» Ã³À½ºÎÅÍ ³¡±îÁö °Ë»çÇÏ¸é¼­ Á¤±ÔÇ¥Çö½Ä°ú ÀÏÄ¡ÇÏ´Â ÀÎµ¦½º¸¦ Ã£Àº °á°ú
		...
		// find : Á¤±Ô Ç¥Çö½ÄÀ» ÅëÇØ Ã£Àº °ÍÀÌ ÀÖÀ¸¸é true
		while(matcher.find()) {
