...
public class A03_varTypes {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	- byte	(1byte)		- 128 ~ + 127
		 	- char	(2byte)		  0 ~ 65535 		-> (65536개, 양수만, 문자를 나타내는것에 최적화)
		 	- short	(2byte)		- 32768 ~ + 32767	-> (음수 포함 65536개)
		 	- int	(4byte)		- 2^16  ~ + 2^16-1 	-> (2^32개)
		 	- long	(8byte)		- 2^32  ~ + 2^32-1  -> (2^64개)
		...
		*/
		...
		char _char = 0;	
		short _short = -32768;	
		int _int = 2100000000;		//21억
		// int의 범위를 벗어나는 숫자를 적을 때에는 뒤에 l/L을 붙여야한다
		...
		*/
		...
		float _float = 123.123F;		// float값을 적을 때에는 뒤에 f/F 를 붙여야 한다
		...
		/*
			# 참/거짓 타입
			- boolean : true, false 두 가지의 값만 대입할 수 있는 변수타입
