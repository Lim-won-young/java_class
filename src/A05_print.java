...
public class A05_print {
	...
	public static void main(String[] args) {
		...
		// ex: 2020년 10월 20일 오전 9:20
		int year = 2020;
		int month = 10;
		int day = 20;
		
		System.out.println(year+"년 "+month+"월 " + day +"일 오전 9:20"); 
		
		System.out.printf("%d년 %d월 %d일 오전 9:20\n",year,month,day);
		...
		System.out.printf("당신의 신용 등급은 '%s' 입니다.\n","1등급");
		...
		// %0숫자d :숫자만큼 칸을 확보한 뒤 빈칸에 0을 채워 출력
		...
		System.out.println("아무 값이나 입력해보시오 > ");
		int num = sc.nextInt();
		System.out.println("입력받은 값 : " + num );
		
		int num2 = sc.nextInt();
		System.out.println("입력받은 두번째 값 : " + num2 );
	}
}
