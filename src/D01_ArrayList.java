...
public class D01_ArrayList {
	...
	// # Java Collections
	//	- 자바에서 기본적으로 제공하는 자료구조 클래스/인터페이스
	...
	public static void main(String[] args) {
		...
		// ArrayList에 타입을 지정해주지 않으면 모든 타입이 들어갈 수 있는 Object타입 ArrayList가 된다
		...
		// # 컬랙션은 Collections의 기능들을 사용할 수 있다
		...
		// 컬랙션에서 등장횟수 구하기
		System.out.println("apple의 등장 횟수 : " + Collections.frequency(fn_list, "apple"));
		...
		// 두 요소의 위치를 교체(스왑) - (Collection, i, j)
