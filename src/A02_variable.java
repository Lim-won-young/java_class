...
public class A02_variable {
	...
	public static void main(String[] args) {
		...
		num1 = 123;
		System.out.println("num1에 저장된 값 : " + num1);
		System.out.println("num5에 저장된 값 : " + num5);
		System.out.println("num6에 저장된 값 : " + num6);
		System.out.println("num7에 저장된 값 : " + num7);
		System.out.println("num8에 저장된 값 : " + num8);
